...
class LabelChecker:
    def __init__(self, path):
        ...
        self.def_labels = [
        "Car_轿车","Pedestrian_行人","Van_面包车","Bus_公交车","Truck_卡车","ScooterRider_骑电动车的人","Scooter_电动车","BicycleRider_骑自行车的人","Bicycle_自行车","Motorcycle_摩托车","MotorcyleRider_骑摩托车的人","PoliceCar_警车","TourCar_观光车","RoadWorker_工人","Child_小孩",
        "BabyCart_婴儿车","Cart_手推车","Cone_雪糕筒","FireHydrant_消防栓","SaftyTriangle_安全三角","PlatformCart_平板车","ConstructionCart_建筑小车","RoadBarrel_安全桶","TrafficBarrier_交通护栏","LongVehicle_长尾拖车","BicycleGroup_电动车自行车堆","ConcreteTruck_水泥车",
        "Tram_电车","Excavator_挖掘机","Animal_动物","TrashCan_垃圾桶","ForkLift_叉车","Trimotorcycle_电动三轮车","FreightTricycle_人力三轮车,","Crane_吊车","RoadRoller_压路机","Bulldozer_推土机","DontCare","Misc","Unknown","Unknown1","Unknown2",
        "Unknown3","Unknown4","Unknown5",
        ]
